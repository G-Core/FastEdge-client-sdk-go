...
type EncodedValue struct {
	// Encoding Encoding of the value
...
// EncodedValueEncoding Encoding of the value
...
// StoreEntryShort KV store entry
...
type StoreKvPairValue struct {
	...
	// Embedded fields due to inline allOf schema
	// Expiry Expiration time in RFC3339 format
...
type StoreSortedSetItem struct {
	...
	EncodedValue `yaml:",inline"`
	// Embedded fields due to inline allOf schema
	// Score Score for sorted set item, not required for delete op
